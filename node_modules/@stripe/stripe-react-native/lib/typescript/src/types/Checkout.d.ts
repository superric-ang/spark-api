...
export declare namespace Checkout {
     ...
     * @internal
     */
    type ErrorCode = 'Failed' | 'InvalidClientSecret' | 'SessionNotOpen' | 'SheetCurrentlyPresented' | 'Canceled';
}
/**
...
export interface Checkout {
     ...
     */
    updateShippingAddress(address: Checkout.Address, name?: string, phone?: string): Promise<void>;
    /**
     ...
     */
    updateBillingAddress(address: Checkout.Address, name?: string, phone?: string): Promise<void>;
    /**
