...
var authenticateUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var authHeader, token, _a, user, error, error_1;
        ...
        switch (_b.label) {
            case 0:
                ...
                if (!authHeader || !authHeader.startsWith('Bearer ')) {
                    return [2 /*return*/, res.status(401).json({ error: 'No authorization token provided' })];
                }
                token = authHeader.substring(7);
                return [4 /*yield*/, server_1.supabase.auth.getUser(token)];
            case 1:
